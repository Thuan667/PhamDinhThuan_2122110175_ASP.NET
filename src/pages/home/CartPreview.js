                ...
                <Dropdown.Menu>
                    <div className="cart-dropdown">
                                    ...
                                    {this.state.cartList.map((item) => (
                                        <div key={item.id} className="product-widget">
                                            <div className="product-img">
                                                <img 
                                                    src={item.stock?.product?.photo ? `/img/${item.stock.product.photo}` : require('../../assets/img/hotdeal.png')} 
                                            ...
                                            <div className="product-body">
                                                ...
                                                <h4 className="product-price">
                                                    <span className="qty">{item.quantity}x</span>{item.stock?.product?.price || 'N/A'} VND
                                                </h4>
                                            </div>
                        ...
                        <div className="cart-summary">
                            ...
                            <h5>SUBTOTAL: {this.state.total} VND</h5>
                        </div>
